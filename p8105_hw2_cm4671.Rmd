...
pols_month_df <- read.csv(
  "~/Desktop/STA-HW/p8105_hw2_cm4671/fivethirtyeight_datasets/pols-month.csv",
  na = c("NA", ".", "")) |>
  janitor::clean_names() |>
...
```{r}
snp_df <- read.csv(
  "~/Desktop/STA-HW/p8105_hw2_cm4671/fivethirtyeight_datasets/snp.csv",
  na = c("NA", ".", "")) |>
  janitor::clean_names() |>
...
unemployment_df <- read.csv(
  "~/Desktop/STA-HW/p8105_hw2_cm4671/fivethirtyeight_datasets/unemployment.csv",
  na = c("NA", ".", "")
) |>
  janitor::clean_names() |>
  pivot_longer(
...
mr_trash_df <- read_excel(
  "~/Desktop/STA-HW/p8105_hw2_cm4671/202409 Trash Wheel Collection Data.xlsx",
...
library(tidyverse)
Zip_Codes <- read.csv(
  "~/Desktop/STA-HW/p8105_hw2_cm4671/zillow_data/Zip Codes.csv",
  na = c("NA", ".", "")) |>
  janitor::clean_names()
Zori <- read.csv(
  "~/Desktop/STA-HW/p8105_hw2_cm4671/zillow_data/Zip_zori_uc_sfrcondomfr_sm_month_NYC.csv", 
  na = c("NA", ".", "")) |>
  janitor::clean_names()
```
